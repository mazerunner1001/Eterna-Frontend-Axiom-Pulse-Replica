...
export default function Home() {
  ...
  // Enable WebSocket after initial render - longer delay on mobile
  React.useEffect(() => {
    const isMobile = window.innerWidth < 1024;
    const delay = isMobile ? 2500 : 1500; // 2.5s on mobile, 1.5s on desktop
    const timer = setTimeout(() => setWsEnabled(true), delay);
