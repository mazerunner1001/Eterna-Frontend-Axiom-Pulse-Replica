...
import { Tooltip, Modal } from '../molecules';
...
const TokenCard: React.FC<{ token: TokenPair }> = React.memo(({ token }) => {
  ...
  return (
    <div className="bg-[#111111] border-b border-r border-[#1f2937]/50 hover:bg-[#151515] active:bg-[#1a1a1a] transition-all px-2 sm:px-4 py-2 flex gap-2 sm:gap-2.5 group">
      ...
      <div className="flex-1 min-w-0 flex flex-col justify-between">
        ...
        <div className="flex items-start justify-between gap-2 mb-1">
          ...
          <div className="flex-1 min-w-0">
            ...
            {/* Age + Icons Row - Simplified for mobile performance */}
            <div className="flex items-center gap-2.5 text-xs">
              <span className="text-teal-400 font-semibold text-[13px]">{token.age}</span>
              <button className="hover:opacity-80 transition-opacity" aria-label="Social Links">
                <Users className="w-4 h-4 text-blue-400" />
              </button>
              <button className="hover:opacity-80 transition-opacity" aria-label="Website">
                <Globe className="w-4 h-4 text-white" />
              </button>
              <span className="text-white text-[13px] font-semibold">{token.holders}</span>
              <button className="hover:opacity-80 transition-opacity" aria-label="Activity">
